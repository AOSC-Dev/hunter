...
fn main() {
    ...
    if !list.is_empty() {
        ...
        println!(
            r#"The following packages installed on your system may be installed from a
third-party source. You may have installed them at some point manually.
